    ...
    <div className="mt-12 w-full flex items-center justify-center">
      <ul className=" w-11/12 md:w-1/2 h-96 overflow-y-auto pr-2">
         ...
         >
           ...
           <span onClick={()=>dispatch(deleteTask(index))} className="w-9 h-8 min-w-8 flex items-center justify-center rounded-md text-white bg-red-600"><FontAwesomeIcon icon={faTrashCan}/></span>
           {items.todo}
           </div>
